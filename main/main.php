    ...
    <?if($_SESSION['userid']){?>
      ...
      <div class="container">
        <div class="content">
          ...
          $result = mysqli_query($con,"select * from list order by number desc limit $first_page,$list");
            ...
            <tr>
              ...
              <tr>
                ...
                while ($row = mysqli_fetch_array($result)) {
                  if ($i %2 == 0) { ?><tr> <?}?>
                    <td><a href="pro_detail.php?number=<?=$row['number']?>&list=<?=$row['list']?>"><img  width="100" height="100" src="./images/<?echo $row['image'].'.'.$row['ext'];?>" alt="image"></a></td>
